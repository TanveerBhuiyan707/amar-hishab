...
<body>
  ...
  <div class="top-bar">
    <div><strong>দোকানের স্টক</strong></div>
    <div class="border p-1 rounded-3 border-secondary"><small>স্টকের ইতিহাস</small></div>
    <!-- <div>
      <img src="https://img.icons8.com/?size=24&id=7625&format=png" alt="PDF" width="24">
