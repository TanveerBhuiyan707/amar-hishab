...
<body>
  ...
  <div class="section border border-1 border-secondary rounded-3 p-3 mb-3">
    ...
    <div class="grid">
      <div class="menu-item"><img src="img/icons-ledger-buy.png"><br>কেনার খাতা</div>
      <div class="menu-item"><img src="img/icons-ledger-sell.png"><br>বিক্রির খাতা</div>
      <div class="menu-item"><img src="img/Balance sheet.png"><br>বাকির খাতা</div>
      <div class="menu-item"><img src="img/Expense ledger.png"><br>খরচের খাতা</div>
    </div>
  </div>
  ...
  <div class="section border border-1 border-secondary rounded-3 p-3 mb-3">
    ...
    <div class="grid  d-flex flex-wrap justify-content-around">
      <div class="menu-item"><img src="img/contact.png"><br>যোগাযোগ</div>
      <div class="menu-item"><img src="img/stock.png"><br>দোকান স্টক </div>
