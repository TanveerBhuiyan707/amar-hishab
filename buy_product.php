    ...
    if (value === "new") {
      ...
      inputDiv.style.display = "none";
        ...
        <div class="tab-pane fade" id="party" role="tabpanel">
          ...
          <input type="text" name="clint_phone" placeholder="এখানে লিখুন" class="form-control" >
        ...
        <div class="tab-pane fade" id="payment" role="tabpanel">
          ...
          <input type="number" placeholder="এখানে লিখুন" name="buy_price" class="form-control" required>
...
function showPaymentFields() {
    ...
    const cashInput = `
        ...
        <input type="number" name="cash_amount" placeholder="পরিমাণ লিখুন" min="0" required><br>
    `;

    const dueInput = `
        <label>বাকি টাকার পরিমাণ:</label>
        <input type="number" name="due_amount" placeholder="পরিমাণ লিখুন" min="0" required><br>
    `;

    const checkInputs = `
        <label>চেকের পরিমাণ:</label>
        <input type="number" name="check_amount" placeholder="পরিমাণ লিখুন" min="0" required><br>
        ...
        <div id="check_common_fields" style="display: none;">
            ...
            <input type="text" name="bank_name" placeholder="ব্যাংকের নাম" required><br>
        </div>
